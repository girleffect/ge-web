...
urlpatterns = [
    ...
    re_path(r"^register/$", views.RegistrationView.as_view(), name="user_register"),
    re_path(
        r"^register/done/",
    ...
    re_path(
        r"^view/myprofile/$", views.MyProfileView.as_view(), name="view_my_profile"
    ),
    re_path(
        r"^edit/myprofile/$", views.MyProfileEdit.as_view(), name="edit_my_profile"
    ),
    re_path(
        r"^password-reset/$",
